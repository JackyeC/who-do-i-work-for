...
Visual / poster direction (for poster_data and any future image briefs): Satire is in copy and layout, not in punching down on groups. poster_data should feel broadly inclusive — avoid imagery or emoji choices that imply only one demographic is "the worker." When describing or implying who appears in share assets, vary age, race/ethnicity, gender, and disability representation across stories in a fair, dignified way (no stereotypes, no tokenism as the joke).`;
