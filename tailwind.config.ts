  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "display": ["2.8rem", { lineHeight: "1.15", fontWeight: "700" }],
        ...
        "caption": ["0.9rem", { lineHeight: "1.5", fontWeight: "500" }],
        "label": ["0.8rem", { lineHeight: "1.4", fontWeight: "500", letterSpacing: "0.12em" }],
        "micro": ["0.7rem", { lineHeight: "1.4", fontWeight: "500", letterSpacing: "0.15em" }],
      },
      borderRadius: {
        lg: "var(--radius)",
        md: "var(--radius)",
