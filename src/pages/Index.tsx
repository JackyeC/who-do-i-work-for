...
const Index = forwardRef<HTMLDivElement>((_, ref) => {
  ...
  return (
    <div ref={ref} className="flex flex-col min-h-screen bg-background">
      ...
      <section className="px-6 lg:px-16 py-20 lg:py-32 max-w-[1100px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div>
          <motion.div
            ...
            className="font-mono text-xs uppercase text-primary mb-4 flex items-center gap-2"
          >
      ...
      <section className="px-6 lg:px-16 py-20 lg:py-24 max-w-[1100px] mx-auto w-full">
        <SectionReveal>
          <div className="font-mono text-xs tracking-[0.2em] uppercase text-primary mb-3">Who It's For</div>
      ...
      <footer className="border-t border-border px-6 lg:px-16 py-6 flex justify-between items-center flex-wrap gap-4">
        ...
        <div className="flex gap-6">
          <a href="/privacy" className="font-mono text-xs tracking-wider text-muted-foreground hover:text-foreground transition-colors">Privacy</a>
          <a href="/terms" className="font-mono text-xs tracking-wider text-muted-foreground hover:text-foreground transition-colors">Terms</a>
          <a href="/methodology" className="font-mono text-xs tracking-wider text-muted-foreground hover:text-foreground transition-colors">Methodology</a>
        </div>
      </footer>
    </div>
  );
