          ...
          <TabsContent value="email" className="px-5 pb-6 pt-4 space-y-4 focus-visible:outline-none">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              {SUBSTACK_NEWSLETTER_URL ? (
                ...
                <p className="text-xs text-muted-foreground">
                  Set <code className="rounded bg-muted px-1 py-0.5">VITE_SUBSTACK_URL</code> to show the live
                  Substack button.
                </p>
              )}
              <Button type="button" variant="outline" size="sm" onClick={() => document.getElementById("newsletter-subscribe")?.scrollIntoView({ behavior: "smooth" })}>
