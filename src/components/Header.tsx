...
import { Search, ClipboardCheck, BookOpen, Briefcase, Plus, HardHat, Target, Bell, Menu, X, FileText } from "lucide-react";
      ...
      <div className="container mx-auto px-4 h-[4.5rem] flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3.5 group">
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[8px] text-civic-gold tracking-[0.2em] uppercase font-semibold mt-0.5">by Jackye Clayton</span>
          </div>
        </Link>
