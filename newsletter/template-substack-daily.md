...
{{GREETING_OPTIONAL}} {{FIRST_NAME_OR_THERE}},

{{ONE_PARAGRAPH_DECK_WHATS_ON_THE_LINE_TODAY}}
...
**People Puzzles take**  
{{PEOPLE_PUZZLES_TAKE_PARAGRAPH}}

**The question that matters**  
{{CLOSING_REFLECTIVE_QUESTION}}

**Decision impact**  
👉 **What this should or could change for you this week:** {{DECISION_IMPACT_LINE}}

**Jackye’s take** *(optional — if distinct from People Puzzles; analysis, not wire):*  
{{JACKYE_TAKE_SHORT_OR_OMIT}}

**Read the full brief on WDIWF:** {{ARTICLE_OR_HUB_URL_WITH_UTM}}
...
{{BODY_2_WITH_SOURCE_MAP_OR_DEVELOPING}}
...
{{BODY_3_WITH_SOURCE_MAP_OR_DEVELOPING}}
...
- {{HIT_1}} — [WDIWF]({{URL_HIT_1}})
- {{HIT_2}} — [WDIWF]({{URL_HIT_2}})
- {{HIT_3}} — [WDIWF]({{URL_HIT_3}})

---

{{CLOSING_JACKYE_SIGNOFF}}

— Jackye

**P.S.** Track the employers that matter to you — [Who Do I Work For](https://wdiwf.jackyeclayton.com?utm_source=substack&utm_medium=email&utm_campaign=daily).  
[LinkedIn](https://www.linkedin.com/in/jackyeclayton/) · [JackyeClayton.com](https://jackyeclayton.com)